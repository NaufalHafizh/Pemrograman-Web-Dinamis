...
if (isset($_POST['update'])) {
    ...
    // update user data
    $result = mysqli_query($con, "UPDATE mahasiswa SET nama='$nama',jkel='$jkel',alamat='$alamat',tgllhr='$tgllhr', semester='$semester' WHERE nim='$nim'");
    ...
    <body>
        ...
        <form name="update_mahasiswa" method="post" action="edit.php">
            <table border="0">
                ...
                <tr>
                    <td>Semester</td>
                    <td><input type="text" name="semester" placeholder="yy/mm/dd" value=<?php echo $semester; ?>></td>
                </tr>
                <tr>
